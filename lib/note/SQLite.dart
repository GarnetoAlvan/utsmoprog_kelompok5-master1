...
class DatabaseHelper {
  ...
  String users =
      "create table users (usrId INTEGER PRIMARY KEY AUTOINCREMENT, usrMail TEXT UNIQUE, usrPassword TEXT)";
  ...
  Future<bool> login(Users user) async {
    ...
    var result = await db.rawQuery(
        "select * from users where usrMail = '${user.usrMail}' AND usrPassword = '${user.usrPassword}'");
