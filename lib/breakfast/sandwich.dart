        ...
        body: Column(
            ...
            children:<Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  SizedBox(width: 20),
                  Text('340g Calories, 19.4g Fat, 15.6g Protein',
                ...
                children: <Widget>[
                  ...
                  Column(
                    children: <Widget>[
                      Padding(padding: EdgeInsets.only(left: 20, right: 20,),
                        child: Text (
                          'Bread, Egg, Cheese Slice, Salt and Pepper, Butter',
              ...
              Padding(padding: EdgeInsets.only(left: 20, top: 5),
                child: Text('1. Heat butter in a pan.',
                    style: GoogleFonts.inter(fontSize: 14, color: Colors.white, height: 1.5)),
              ),
              Padding(padding: EdgeInsets.only(left: 20,),
                child: Text('2. Cook the egg sunny-side-up with salt and pepper.',
                    style: GoogleFonts.inter(fontSize: 14, color: Colors.white, height: 1.5)),
              ),
              Padding(padding: EdgeInsets.only(left: 20,),
                child: Text('3. Place the cooked egg and cheese between two slices of bread.',
                    style: GoogleFonts.inter(fontSize: 14, color: Colors.white, height: 1.5)),
              ),
              Padding(padding: EdgeInsets.only(left: 20,),
                child: Text('4. Grill the sandwich until the bread is golden and the cheese is melted.',
                    style: GoogleFonts.inter(fontSize: 14, color: Colors.white, height: 1.5)),
              ),
            ]
        )
